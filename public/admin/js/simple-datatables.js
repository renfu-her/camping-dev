                ...
                (function() {
                    ...
                    const X = {
                        ...
                        labels: {
                            ...
                            perPage: "條每頁",
                            noRows: "目前沒有資料",
                            noResults: "沒有結果符合您的搜索查詢",
                            info: "顯示 {start} 到 {end} 條，共 {rows} 條數據"
                        },
                    ...
                    class tt {
                        ...
                        dismiss(t) {
                            ...
                            if (!(e instanceof Element))
                                return;
                            let s = !0;
                            this.options.contextMenu && (s = !this.wrapperDOM.contains(e),
                            this.editing && (s = !this.wrapperDOM.contains(e) && !e.matches(`input.${this.options.classes.input}[type=text]`))),
                            s && (this.editingCell && this.saveCell(this.data.content),
                            this.closeMenu())
                        }
                        openMenu() {
                            if (this.editing && this.data && this.editingCell) {
